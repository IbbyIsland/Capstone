...
public class Scenario1 {
	...
	public Scenario1() {
		...
		stage1.setTitle("CyberTeach, The game for Teenagers!       Network Security");
	...
	public void answerOptions() {
		...
		labeloption4.setFont(new Font("Cambria", 18));
		labeloption42.setFont(new Font("Cambria", 18));
		labeloption3.setFont(new Font("Cambria", 18));
		labeloption32.setFont(new Font("Cambria", 18));
		labeloption33.setFont(new Font("Cambria", 18));
		labeloption2.setFont(new Font("Cambria", 18));
		labeloption22.setFont(new Font("Cambria", 18));
		labeloption23.setFont(new Font("Cambria", 18));
		labeloption1.setFont(new Font("Cambria", 18));
		labeloption12.setFont(new Font("Cambria", 18));
		
		//for A,B,C, set the thing to wrap text.
		labeloption1.setWrapText(true);
		labeloption1.setMaxWidth(500);
		labeloption12.setWrapText(true);
		labeloption12.setMaxWidth(500);
		labeloption2.setWrapText(true);
		labeloption2.setMaxWidth(500);
		labeloption22.setWrapText(true);
		labeloption22.setMaxWidth(500);
		labeloption23.setWrapText(true);
		labeloption23.setMaxWidth(500);
		labeloption3.setWrapText(true);
		labeloption3.setMaxWidth(580);
		labeloption32.setWrapText(true);
		labeloption32.setMaxWidth(580);
		labeloption33.setWrapText(true);
		labeloption33.setMaxWidth(580);
...
//			firstImage.relocate(0, 0);
			...
			labeloption1.setLayoutY(300);
			labeloption12.setLayoutX(1000);
			labeloption12.setLayoutY(350);
			
			
			
			labeloption1.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
			labeloption12.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
...
//			labelExp.setLayoutY(800);
		...
		option2.setOnAction(e -> {
			...
			labeloption2.setLayoutY(300);
			labeloption22.setLayoutX(1000);
			labeloption22.setLayoutY(350);
			labeloption23.setLayoutX(1000);
			labeloption23.setLayoutY(400);
		...
		option3.setOnAction(e -> {
			...
			labeloption3.setLayoutY(300);
			labeloption32.setLayoutX(800);
			labeloption32.setLayoutY(350);
			labeloption33.setLayoutX(800);
			labeloption33.setLayoutY(400);
			labeloption3.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
			labeloption32.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
			labeloption33.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
		...
		option4.setOnAction(e -> {
			...
			labeloption4.setLayoutY(300);
			labeloption42.setLayoutX(800);
			labeloption42.setLayoutY(350);
			labeloption4.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
			labeloption42.setTextFill(javafx.scene.paint.Color.rgb(5, 41, 0));
