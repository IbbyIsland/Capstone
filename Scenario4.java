...
public class Scenario4 {
	...
	Label option4Answer = new Label("Correct! Using time stamps to verifying them for when the reading log was signed, which we also use in Cybersecurity. By using a time stamp in Cybersecurity, we can verify when actions were taken place and as such, getting accurate results of when certain events happened. ");
	...
	public Scenario4() {
		...
		stage4.setTitle("CyberTeach, The game for Teenagers!");
