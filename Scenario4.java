...
public class Scenario4 {
	...
	public void playable() {
		...
		Label option1 = new Label("Make sure that the signature is in the exact same appearance as the parents previous forms, to make sure it wasn't forged or tampered with. ");
		option1.setLayoutX(50);
		option1.setLayoutY(300);
		option1.setFont(new Font("Cambria", 20));
		...
		option2.setFont(new Font("Cambria", 20));
		...
		option3.setFont(new Font("Cambria", 20));
		...
		option4.setFont(new Font("Cambria", 20));
