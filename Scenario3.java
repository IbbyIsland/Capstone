...
public class Scenario3 {
	...
	public Label option4Answer = new Label("Correct! Using something like AES to encrypt the data would keep it confidential so that only the destination reader can make sense of it.");
	...
	public Scenario3() {
		...
		stage3.setTitle("CyberTeach, The game for Teenagers!         Encryption, Obfuscation, and Confusion");
	...
	public void scenarioOptions() {
		...
		option1Label.setFont(new Font("Cambria", 18));
		option1Label.setTextFill(Color.BLUE);
		option1Label.setMaxWidth(700);
		option1Label.setWrapText(true);
		
		RadioButton option1 = new RadioButton("A");
		option1.setLayoutX(0);
		option1.setLayoutY(220);
		option1.setFont(new Font("Cambria", 17));
		option1.setTextFill(Color.BLUE);
		...
		option2Label.setFont(new Font("Cambria", 18));
		option2Label.setTextFill(Color.BLUE);
		option2Label.setMaxWidth(700);
		option2Label.setWrapText(true);
		RadioButton option2 = new RadioButton("B");
		option2.setFont(new Font("Cambria", 17));
		option2.setTextFill(Color.BLUE);
		...
		option3Label.setFont(new Font("Cambria", 18));
		option3Label.setTextFill(Color.BLUE);
		option3Label.setMaxWidth(700);
		option3Label.setWrapText(true);
		RadioButton option3 = new RadioButton("C");
		option3.setFont(new Font("Cambria", 17));
		option3.setTextFill(Color.BLUE);
		...
		option4Label.setLayoutY(370);
		option4Label.setFont(new Font("Cambria", 18));
		option4Label.setTextFill(Color.BLUE);
		option4Label.setMaxWidth(600);
		option4Label.setWrapText(true);
		
		RadioButton option4 = new RadioButton("D");
		option4.setFont(new Font("Cambria", 17));
		option4.setTextFill(Color.BLUE);
		...
		option1.setOnAction(e -> {
			...
			option1Answer.setFont(new Font("Cambria", 18));
		...
		option2.setOnAction(e -> {
			...
			option2Answer.setTextFill(javafx.scene.paint.Color.MAROON);
			option2Answer.setFont(new Font("Cambria", 18));
		...
		option3.setOnAction(e -> {
			...
			option3Answer.setFont(new Font("Cambria", 18));
			option3Answer.setMaxWidth(600);
			option3Answer.setWrapText(true);
			
			if (!pane.getChildren().contains(option3Image) && !pane.getChildren().contains(option3Answer)) {
		...
		option4.setOnAction(e -> {
			...
			option4Answer.setFont(new Font("Cambria", 18));
			option4Answer.setMaxWidth(600);
