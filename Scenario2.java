...
public class Scenario2 {
	...
	public Scenario2() {
		...
		stage2.setTitle("CyberTeach, The game for Teenagers!     Password Security");
		...
		optionLabelB.setFont(new Font("Cambria", 20));
		optionLabelC.setFont(new Font("Cambria", 20));
		optionLabelD.setFont(new Font("Cambria", 20));
		optionLabelE.setFont(new Font("Cambria", 20));
		optionLabelA.setFont(new Font("Cambria", 20));
		
		option2LabelB.setFont(new Font("Cambria", 20));
		option2LabelC.setFont(new Font("Cambria", 20));
		option2LabelD.setFont(new Font("Cambria", 20));
		option2LabelA.setFont(new Font("Cambria", 20));
	...
	public void actualLabel1() {
		...
		//if its LIGHTGREEN, color the wholebackground LIGHTGREEN with a label text
		...
		prompt.setStyle("-fx-border-color: blue;");
...
//		labelOptions.setLayoutX(0);
		...
		optionA.setOnAction(e -> {
			...
			optionLabelA.setFont(new Font("Cambria", 18));
		...
		optionB.setOnAction(e -> {
			...
			optionLabelB.setFont(new Font("Cambria", 18));
		...
		optionC.setOnAction(e -> {
			...
			optionLabelC.setFont(new Font("Cambria", 18));
		...
		optionD.setOnAction(e -> {
			...
			optionLabelD.setFont(new Font("Cambria", 18));
		...
		optionE.setOnAction(e -> {
			...
			optionLabelE.setTextFill(javafx.scene.paint.Color.LIGHTGREEN);
			optionLabelE.setFont(new Font("Cambria", 18));
	...
	public void actualLabel2() {
		...
		optionA.setOnAction( e -> {
			...
			option2LabelA.setFont(new Font("Cambria", 18));
		...
		optionB.setOnAction(e -> {
			...
			option2LabelB.setFont(new Font("Cambria", 18));
			option2LabelB.setMaxWidth(600);
		...
		optionC.setOnAction(e ->{
			...
			option2LabelC.setFont(new Font("Cambria", 18));
			option2LabelC.setWrapText(true);
			option2LabelC.setMaxWidth(600);
		...
		optionD.setOnAction(e -> {
			...
			option2LabelD.setFont(new Font("Cambria", 18));
			option2LabelD.setWrapText(true);
			option2LabelD.setMaxWidth(600);
