...
public class Scenario5Learner {
	...
	public Scenario5Learner() {
		...
		stageLearn5.setTitle("Learner Window : FireWall");
	...
	public void network() {
		...
		label4.setFont(new Font("Cambria", 15));
	...
	public void fireWall() {
		...
		destinationIp.getItems().add("Any");
		...
		listener.setOnAction(e -> {
			//clear the entire thing once clicked, from anything else that had been up
			lineforInternet.setVisible(false);
			lineforWeb.setVisible(false);
			lineforEmail.setVisible(false);
			lineforDNS.setVisible(false);
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				//make everything red
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				//make everything red
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.RED);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.LIMEGREEN);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.RED);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "Any" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.LIMEGREEN);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "587-SMTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.RED);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "587-SMTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.RED);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "587-SMTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.LIMEGREEN);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "587-SMTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.LIMEGREEN);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "80-HTTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.RED);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "80-HTTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.RED);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "80-HTTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.LIMEGREEN);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "80-HTTP" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.LIMEGREEN);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "53-DNS" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.RED);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "53-DNS" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.RED);
				linefor211.setVisible(true);
			...
			if (ports.getValue() == "53-DNS" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.10" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor210.setStroke(Color.LIMEGREEN);
				linefor210.setVisible(true);
			...
			if (ports.getValue() == "53-DNS" && sourceIp.getValue() == "Any" && destinationIp.getValue() == "200.1.1.11" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				linefor211.setStroke(Color.LIMEGREEN);
				linefor211.setVisible(true);
			...
			//conditions for if the internet wants to connect to any other services
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.2" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				lineforWeb.setStroke(Color.RED);
				lineforWeb.setVisible(true);
			...
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.2" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				lineforWeb.setStroke(Color.LIMEGREEN);
				lineforWeb.setVisible(true);
			...
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.3" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				lineforDNS.setStroke(Color.RED);
				lineforDNS.setVisible(true);
			...
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.3" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				lineforDNS.setStroke(Color.LIMEGREEN);
				lineforDNS.setVisible(true);
			...
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.4" && actions.getValue() == "Deny") {
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
				lineforEmail.setStroke(Color.RED);
				lineforEmail.setVisible(true);
			...
			if(sourceIp.getValue() == "Any" && destinationIp.getValue()== "200.1.1.4" && actions.getValue() == "Permit") {
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
				lineforEmail.setStroke(Color.LIMEGREEN);
				lineforEmail.setVisible(true);
			...
			if(sourceIp.getValue() == "200.1.1.4" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				lineforEmail.setStroke(Color.RED);
				lineforEmail.setVisible(true);
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.4" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				lineforEmail.setStroke(Color.LIMEGREEN);
				lineforEmail.setVisible(true);
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
			...
			if(sourceIp.getValue() == "200.1.1.3" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				lineforDNS.setStroke(Color.RED);
				lineforDNS.setVisible(true);
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.3" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				lineforDNS.setStroke(Color.LIMEGREEN);
				lineforDNS.setVisible(true);
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.2" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				lineforWeb.setStroke(Color.RED);
				lineforWeb.setVisible(true);
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.2" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				lineforWeb.setStroke(Color.LIMEGREEN);
				lineforWeb.setVisible(true);
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
			...
			if(sourceIp.getValue() == "200.1.1.10" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				linefor210.setStroke(Color.RED);
				linefor210.setVisible(true);
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.10" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				linefor210.setStroke(Color.LIMEGREEN);
				linefor210.setVisible(true);
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.11" && destinationIp.getValue() == "Any" && actions.getValue() == "Deny") {
				linefor211.setStroke(Color.RED);
				linefor211.setVisible(true);
				lineforInternet.setStroke(Color.RED);
				lineforInternet.setVisible(true);
			}
			if(sourceIp.getValue() == "200.1.1.11" && destinationIp.getValue() == "Any" && actions.getValue() == "Permit") {
				linefor211.setStroke(Color.LIMEGREEN);
				linefor211.setVisible(true);
				lineforInternet.setStroke(Color.LIMEGREEN);
				lineforInternet.setVisible(true);
